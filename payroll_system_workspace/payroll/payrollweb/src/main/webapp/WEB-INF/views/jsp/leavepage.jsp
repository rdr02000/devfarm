...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<c:url value='/resources/startbootstrap/vendor/bootstrap/css/bootstrap.min.css'/>" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="<c:url value='/resources/startbootstrap/vendor/metisMenu/metisMenu.min.css'/>" rel="stylesheet">
    ...
    <!-- Custom Fonts -->
    <link href="<c:url value='/resources/startbootstrap/vendor/font-awesome/css/font-awesome.min.css'/>" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                ...
                                <div>Your VL request for June 12 2017 has been approved.</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                ...
                                <div>Your overtime request for June 30 2017 has been denied</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i>Employee Leaves<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="panels-wells.html">List of Leaves</a>
                                </li>
                                <li>
                                    <a href="buttons.html">Apply Leave</a>
                                </li>
                                <li>
                                    <a href="notifications.html">Available Leaves</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i>Employee Overtime<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">List of Overtimes</a>
                                </li>
                                <li>
                                    <a href="#">Apply Overtime</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
              <jsp:include page="/WEB-INF/views/jsp/dtr.jsp"></jsp:include>
        </div>
        <!-- /#page-wrapper -->
