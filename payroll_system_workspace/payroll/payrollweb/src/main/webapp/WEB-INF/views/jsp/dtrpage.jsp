...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
              <jsp:include page="/WEB-INF/views/jsp/payrollworklist.jsp" />
        </div>
    </div>
</body>

<script src="<c:url value='/resources/payrolljs/dtrtablemodal.js' />" ></script>
<script src="<c:url value='/resources/payrolljs/leavetablemodal.js' />" ></script>
<script src="<c:url value='/resources/payrolljs/overtimetablemodal.js' />" ></script>
<script src="<c:url value='/resources/payrolljs/payrollweekdetails.js' />" ></script>
<script src="<c:url value='/resources/payrolljs/payrollworklist.js' />" ></script>
...
<script>
	$(document).ready( function() {
 		...
 		LeaveModal.bindEvent();
 		
 		OvertimeModal.init("#overtime-table-id",".overtime-event")
 		OvertimeModal.bindEvent();
	})
</script>
